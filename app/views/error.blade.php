...
<!DOCTYPE html>
<!-- saved from url=(0061)http://htmlstream.com/preview/unify-v1.5/page_404_error3.html -->
<html lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- CSS Page Style -->    
    <link rel="stylesheet" href="/app/css/page_error4_404.css">
    ...
    <div class="container content">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="error-v4">
                    <a href="http://htmlstream.com/preview/unify-v1.5/page_404_error3.html#"><img src="" alt=""></a>
                    <?php $errors = $errors->toArray();?>
                    ...
                    <script language="javascript" type="text/javascript"> 
                        ...
                        function fun() { 
                        if (i == 0) { 
                        window.location.href = "<?php $errors['url'];?>"; 
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a class="btn-u btn-brd btn-u-light" href="<?php echo url('/')?>"><span id="mes">5</span> 秒钟后返回</a>
                        </div> 
                    </div> 
                </div>
            </div>
